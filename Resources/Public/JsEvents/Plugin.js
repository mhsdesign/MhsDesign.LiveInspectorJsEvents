...
var filterOutPropertiesWithUnderscore = exports.filterOutPropertiesWithUnderscore = function filterOutPropertiesWithUnderscore(obj) {
    return filterObject(obj, function (key, value) {
...
var _onNodeChangeSendEvent = __webpack_require__(/*! ./onNodeChangeSendEvent */ "./src/onNodeChangeSendEvent.js");

var _onNodeChangeSendEvent2 = _interopRequireDefault(_onNodeChangeSendEvent);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _neosUiExtensibility2.default)('MhsDesign.LiveInspectorJsEvents:JsEvents', {}, function (globalRegistry) {
    var sagasRegistry = globalRegistry.get('sagas');
    sagasRegistry.set('MhsDesign.LiveInspectorJsEvents/JsEvents', { saga: _onNodeChangeSendEvent2.default });
});

/***/ }),

/***/ "./src/neos-ui-guest-frame.js":
/*!************************************!*\
  !*** ./src/neos-ui-guest-frame.js ***!
  \************************************/
/*! no static exports found */
...
var getGuestFrameDocument = function getGuestFrameDocument() {
    var guestFrame = document.getElementsByName('neos-content-main')[0];
    return guestFrame && guestFrame.contentDocument;
};

var dispatchCustomEvent = exports.dispatchCustomEvent = function dispatchCustomEvent(eventName, eventDescription) {
...
exports.default = onNodeChangeSendEvent;
...
var _neosUiGuestFrame = __webpack_require__(/*! ./neos-ui-guest-frame */ "./src/neos-ui-guest-frame.js");

var _marked = /*#__PURE__*/regeneratorRuntime.mark(onNodeChangeSendEvent);
// TODO: use consumer api soon: https://github.com/neos/neos-ui/pull/2945


function onNodeChangeSendEvent() {
    return regeneratorRuntime.wrap(function onNodeChangeSendEvent$(_context3) {
        while (1) {
            switch (_context3.prev = _context3.next) {
                case 0:
                    _context3.next = 2;
                    return (0, _effects.takeLatest)(_neosUiReduxStore.actionTypes.UI.Inspector.COMMIT, /*#__PURE__*/regeneratorRuntime.mark(function _callee(action) {
                        var node, changedNodeProperty;
                            ...
                            while (1) {
                                switch (_context.prev = _context.next) {
                                    case 0:
                                        ...
                                        node = action.payload.focusedNode;
                                        changedNodeProperty = {};

                                        changedNodeProperty[action.payload.propertyId] = action.payload.value;

                                        (0, _neosUiGuestFrame.dispatchCustomEvent)('MhsDesign.LiveInspectorJsEvents', 'COMMIT', {
                                            node: node,
                ...
                case 2:
                    _context3.next = 4;
                    return (0, _effects.takeLatest)(_neosUiReduxStore.actionTypes.UI.Inspector.DISCARD, /*#__PURE__*/regeneratorRuntime.mark(function _callee2(action) {
                        var state, node;
                            ...
                            while (1) {
                                switch (_context2.prev = _context2.next) {
                                    ...
                                    case 2:
                                        ...
                                        node = _neosUiReduxStore.selectors.CR.Nodes.nodeByContextPath(state)(action.payload.focusedNodeContextPath);


                                        (0, _neosUiGuestFrame.dispatchCustomEvent)('MhsDesign.LiveInspectorJsEvents', 'DISCARD', {
                                            node: node,
                                            properties: (0, _helpers.filterOutPropertiesWithUnderscore)(node.properties)
                                        });
...
node = {
    ...
    "properties": {
        ...
        "_path": "/sites/mhs-spa/main/node-l461lxh2i1a77",
        "_name": "node-l461lxh2i1a77",
        "_nodeType": "Mhs.Spa:Content.Heading",
        ...
        "title": "my String old"
}
...
discardAction = {
    ...
    "payload": {
        "focusedNodeContextPath": "/sites/mhs-spa/main/node-l461lxh2i1a77@user-mhs"
